...
export class AppComponent {
  ...
  // City names
  City: any = ['Kerala', 'UttarPradesh', 'Maharashtra', 'Bihar', 'TamilNadu', 'Punjab', 'Karnataka', 'Rajasthan', 'Gujrat', 'AndraPradesh', 'Haryana']
  ...
  imageUrl: any = 'https://picsum.photos/seed/picsum/200/300';
  ...
  onSubmit() {
    ...
    if(!this.registrationForm.valid) {
      alert('Please fill all the required fields to create a record!')
      return false;
    } else {
